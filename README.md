...
## Homework 2 - 202655330 (Your ID) PARK MIN JUN
...
| 3 | NOT P IFF Q | $$/negP \leftrightarrow Q$$ |
| 4 | FOR ALL x, P(x) | $$/forallx, P(x)$$ |
| 5 | THERE EXISTS AN x, NOT Q(x) | $$/existQ(x)$$, $$/negQ$$ |
| 6 | IF P THEN Q EQUIVALENT TO NOT P OR Q | $$P /rightarrow Q$$ $$\equiv /negP /veeQ$$ |
| 7 | Euler's Identity |  $$e^i\pi$$ + 1 = 0  |
| 8 | SUM of n from 1 to 100 Equals 5050 | $${\substack{n-1}}\sum_{\substack{n-1}} n = 5050$$ |
